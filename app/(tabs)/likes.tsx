  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={[styles.header, { top: insets.top, }]}>
        <Animated.Text style={[styles.headerText, { opacity: headerOpacity }]}>Du gefällst</Animated.Text>
      </View>
      ...
      >
        {/* Main title */}
        <Text style={styles.mainTitle}>Du gefällst</Text>

        {
          likes.length == 0 ? (
            <View style={{ paddingHorizontal: 20, gap: 8 }}>
              <Image 
                source={require("../../assets/images/dove-flying.png")} 
                style={{ height: "70%", width: "100%", resizeMode: "contain" }}
              />
              <Text style={{ fontWeight: "bold", fontSize: 20, textAlign: "center" }}>Du bist neu und hast noch keine Likes</Text>
              <Text style={{ textAlign: "center", fontSize: 15, color: "#4E4C4D" }}>Wir können dir helfen, dass es früher klappt.</Text>
